            ...
            <div class="row">
                <div class="col-lg-7 col-md-6 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Confirfed Orders</li>
                    </ul>
...
fhhfgrhui
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        @if ($singleOrder->actionStatus == 3)

          <a id="navbarDropdown1" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre="">
            <span class="caret"><span class="badge badge-pill badge-success">Confirmed</span></span>
          </a>
