...
<script src={{ asset('dashboard/assets/plugins/jquery-validation/jquery.validate.js') }}"></script> <!-- Jquery Validation Plugin Css -->
<script src="{{ asset('dashboard/assets/plugins/jquery-steps/jquery.steps.js') }}"></script> <!-- JQuery Steps Plugin Js -->
<script src="{{ asset('dashboard/assets/plugins/dropify/js/dropify.min.js') }}"></script>

<script src="{{ asset('dashboard/assets/plugins/select2/select2.min.js') }}"></script> <!-- Select2 Js -->
...
<script src="{{ asset('dashboard/assets/js/pages/forms/form-validation.js') }}"></script>
<!-- VENDOR JS -->
